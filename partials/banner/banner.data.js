export const bannerContext = {
  slides: [
    ...
    },
    {
      ...
      images: [
        {
          'webp': '/images/banner/banner-second-chair.webp',
          'webp@2x': '/images/banner/banner-second-chair@2x.webp',
          'jpeg': '/images/banner/banner-second-chair.png',
          'jpeg@2x': '/images/banner/banner-second-chair@2x.png',
          'class': 'banner__image banner__image--chair',
          'alt': 'chair',
          'sequence': 'scale, from-down, 0, 1.2, 3',
        },
        {
          'webp': '/images/banner/banner-second-catalog.webp',
          'webp@2x': '/images/banner/banner-second-catalog@2x.webp',
          'jpeg': '/images/banner/banner-second-catalog.png',
          'jpeg@2x': '/images/banner/banner-second-catalog@2x.png',
          'class': 'banner__image banner__image--catalog',
          'alt': 'catalog',
          'sequence': 'scale, from-down, 0, 1.5, 4',
        },
        {
          'webp': '/images/banner/banner-second-chair-big.webp',
          'webp@2x': '/images/banner/banner-second-chair-big@2x.webp',
          'jpeg': '/images/banner/banner-second-chair-big.png',
          'jpeg@2x': '/images/banner/banner-second-chair-big@2x.png',
          'class': 'banner__image banner__image--chair-big',
          'alt': 'chair-big',
          'sequence': 'scale, from-down, 0, 1.3, 1',
        },
        {
          'webp': '/images/banner/banner-second-chair-filter.webp',
          'webp@2x': '/images/banner/banner-second-chair-filter@2x.webp',
          'jpeg': '/images/banner/banner-second-chair-filter.png',
          'jpeg@2x': '/images/banner/banner-second-chair-filter@2x.png',
          'class': 'banner__image banner__image--chair-filter',
          'alt': 'chair-filter',
          'sequence': 'scale, from-down, 0, 1.1, 2',
        },
        {
          'webp': '/images/banner/banner-second-banquet.webp',
          'webp@2x': '/images/banner/banner-second-banquet@2x.webp',
          'jpeg': '/images/banner/banner-second-banquet.png',
          'jpeg@2x': '/images/banner/banner-second-banquet@2x.png',
          'class': 'banner__image banner__image--banquet',
          'alt': 'banquet',
          'sequence': 'scale, from-down, 0, 1.4, 10',
        },
        {
          'webp': '/images/banner/banner-second-place-order.webp',
          'webp@2x': '/images/banner/banner-second-place-order@2x.webp',
          'jpeg': '/images/banner/banner-second-place-order.png',
          'jpeg@2x': '/images/banner/banner-second-place-order@2x.png',
